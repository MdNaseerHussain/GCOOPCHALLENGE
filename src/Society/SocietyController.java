...
public abstract class SocietyController {
    private static ArrayList<Society> societies = new ArrayList<Society>(Arrays.asList(new Society("Neuromancers"), new Society("RISC"), new Society("Kalakriti")));
